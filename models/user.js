 ...
 * Program Name  :  api/common/installarea/installarea.model.js
 * Description   :
 *                 
 *                 
 * Author        :
...
User.method('save', function(next, cb){
    ...
    database.simpleExecute(
        ' select emp_no as "empno", emp_name as "empname", emp_pass as "password",  role as "role" ' +
