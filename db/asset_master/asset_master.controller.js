 ...
 * Program Name  : 자산마스타
 * File          : asset_master.controller.js
 * Description   :
...
var AssetMaster = require('./asset_master.service');
// Search Records
// GET     /url  --> All
// GET     /url?field1=value1&field2=value2... --> Query
exports.search = function(req, res) {

    var asset_master = new AssetMaster(req.query);

    asset_master.search(function (err, result) {
...
exports.show = function(req, res) {
    ...
    var asset_master = new AssetMaster(req.params);

    asset_master.findById(function (err, entity) {
        if (err) { return handleError(res, err); }
...
exports.insert = function(req, res) {
    var asset_master = new AssetMaster(req.body);

    asset_master.insert(function(err, result) {
        if(err) { return handleError(res, err); }
...
exports.update = function(req, res) {
    ...
    asset_master.findById(function (err, entity) {
        ...
        asset_master = new AssetMaster(req.body);
        asset_master.update(function(err, result) {
...
exports.delete = function(req, res) {
    ...
    asset_master.findById(function (err, entity) {
        ...
        asset_master = new AssetMaster(entity);
        asset_master.delete(function(err, result) {
