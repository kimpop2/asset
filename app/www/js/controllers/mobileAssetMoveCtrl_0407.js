...
(function() {
    ...
    function($scope, $http, $log, ebizAlert, asset_move, asset_master, ebizList, $cordovaBarcodeScanner, $cordovaNfc, $cordovaNfcUtil) {
    	...
    	function initData(){
	    	...
	    	asset_move_data.txn_type        = 'exec_madd';
	    	asset_move_data.move_flag       = 'MOVE';
	    	asset_move_data.request_charger = 'ADMIN';
	    	asset_move_data.process_charger = 'ADMIN';
	    }
	    initData();
        ...
        * ------------------------------------------------- */
        ...
        var addNfc = function(event) {
        	...
        	$scope.myform.barcode    = JSON.stringify(ndefMessage);
